						...
						f.add("data-uri", function (a, f) {
							...
							return u.length >= v && this.context.ieCompat !== !1
								? (h.warn(
								  ...
								  g(this, f || a))
								: new d(new c('"' + u + '"', u, !1, this.index, this.currentFileInfo), this.index, this.currentFileInfo)
						})
					}
				},
					...
					;(j.prototype = new e()),
						...
						(j.prototype.eval = function (a) {
							...
							try {
								...
								throw (
									("number" != typeof m.index && ((m.index = this.getIndex()), (m.filename = this.fileInfo().filename)),
									m)
								)
							} finally {
								e && (a.math = b)
							...
							if (this.options.isPlugin) {
								if (this.root && this.root.eval)
									try {
										...
										throw (
											((f.message = "Plugin error during evaluation"), new k(f, this.root.imports, this.root.filename))
										)
									}
								return (
							...
							return a
								? ("string" == typeof a &&
										this.parse.parseNode(a, ["selector"], this._index, this._fileInfo, function (b, c) {
											if (b)
												throw new f({ index: b.index, message: b.message }, this.parse.imports, this._fileInfo.filename)
											a = c[0].elements
										}),
								  a)
						...
						var c = (function () {
							...
							function c(d, e, f, g, j) {
								function m(d, f) {
									...
									else if (c.__isRegExp(d)) (q = new RegExp(d.source, h(d))), d.lastIndex && (q.lastIndex = d.lastIndex)
